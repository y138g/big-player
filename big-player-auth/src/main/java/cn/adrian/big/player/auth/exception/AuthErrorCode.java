package cn.adrian.big.player.auth.exception;


import cn.adrian.big.player.base.exception.ErrorCode;
...
public enum AuthErrorCode implements ErrorCode {
     ...
     * 用户状态不可用
     */
    USER_STATUS_IS_NOT_ACTIVE("USER_STATUS_IS_NOT_ACTIVE", "用户状态异常"),
